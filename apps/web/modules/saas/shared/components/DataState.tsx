 ...
 * ```
 */
// react-doctor-disable-next-line deslop/unused-export -- public module API surface re-exported via the @saas/shared/client barrel; intended reusable data-state component
