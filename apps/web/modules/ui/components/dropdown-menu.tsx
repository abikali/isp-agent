...
const DropdownMenuSubContent = ({
	...
	// Portalled like DropdownMenuContent — rendered inline it sits inside the
	// parent menu's overflow-hidden scroll container and gets clipped.
...
const DropdownMenuContent = ({
	...
	<DropdownMenuPrimitive.Portal>
		<DropdownMenuPrimitive.Content
			...
			className={cn(
				"z-50 max-h-[var(--radix-dropdown-menu-content-available-height)] min-w-[8rem] max-w-[calc(100vw-1rem)] overflow-y-auto overflow-x-hidden rounded-lg border border-border bg-popover/95 p-1.5 text-popover-foreground shadow-lg backdrop-blur-sm",
